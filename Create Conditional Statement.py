...
# [When OS 2 is running you get the display or output of no update needed, but when OS 3 is running you get no return at all.]
# 
...
# [When OS 2 is running you will get the response of "no update needed". If you are running any other OS then you willl get the return of "Update needed"]
# 
...
# [If you are running a system with the correct OS (2) then you will recieve a no update needed message. If you run 1 or 3 you will recievee a message that you need to update. If you run a OS not indicated in the code you recieve neither message at all]
# 
...
# [Messing with your indicators <,>, != will give you the desired ourcome to cover all bases needed for your code.]
# 
...
# [When an approved user tries to log in the code will search the approved list. If they match with it then they recieve the message that they have access tot the device. If this fails and they are not on the list then they recieve a message saying that they do not have access.]
# 
...
# [If made during house you will get a resonse of login made during hours, if not then you will get a message saying you made them out of hours]
# 
...
# #### **Question 7**
# **What happens when the user trying to log in is not among the approved users? They will recioeve a message stating that they do not have access to the device. What happens when the user trying to log in is among the approved users? They will get an access granted message.What happens when the user tries to log in outside of organization hours? A message will pop up stating that it is a login in attempt outside of org hours**
...
# 
# [This lab was difficult but served as a learning moment for my python coding]
